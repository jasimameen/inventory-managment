...
import '../../../application/errand/errand_bloc.dart' as _i20;
import '../../../application/route/route_bloc.dart' as _i15;
import '../../../application/sales/sales_bloc.dart' as _i16;
import '../../../application/shop/shop_bloc.dart' as _i17;
import '../../../application/stock/stock_bloc.dart' as _i18;
import '../../../application/warehouse/warehouse_bloc.dart' as _i19;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i16.SalesBloc>(() => _i16.SalesBloc());
  gh.factory<_i17.ShopBloc>(() => _i17.ShopBloc(
      get<_i9.IShopRepo>(), get<_i7.IRouteRepo>(), get<_i11.IStockRepo>()));
  gh.factory<_i18.StockBloc>(() => _i18.StockBloc(get<_i11.IStockRepo>()));
  gh.factory<_i19.WarehouseBloc>(
      () => _i19.WarehouseBloc(get<_i13.IWareHouseRepo>()));
  gh.factory<_i20.ErrandBloc>(() => _i20.ErrandBloc(get<_i5.IErrandRepo>()));
  return get;
}
